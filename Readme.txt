...
STEP 2: 
Input SMPS to terminal to obtain solution file (.sol). Please adjust the directory according. The following is the example
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Run 74-123-Network:

Adjust your the first stage solution after the solution for smaller scenario case is avaible
