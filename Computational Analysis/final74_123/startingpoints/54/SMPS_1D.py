...
D_mat = pd.read_excel('Demand.xlsx').values[:,1: number_scenario + 1][0:]
Demand_Multiplier = 6
...
Utility  = pd.read_excel('Utility.xlsx',index_col=[0,1])
...
# J = [1,2,3, 6,7,10,13,17,21,22,23,24,25,26,29,30,31,32,33,35,36,42,43,44,45,46,48,52,53,54,57,59,60,63,67,69]
# TN_PDN = {1:1, 2:15, 3:16, 6:14, 7:13, 10:10, 13:14, 17:33, 21:17, 22:9, 23:3, 24:2, 25:4, 26:5, 29:11, 30:8, 31:13,
#           32:9, 33:10, 35:43,36:44,42:46,43:48,44:49,45:50,46:115,48:118,52:113,53:95,54:84,57:58,59:59,60:68,63:80, 67:88, 69:87,
#           0:-1}



# J = [1,2,3, 6,7,10,17,21,22,23,24,25,26,29,30,31,32,33,35,36,42,43,44,45,46,48,52,53,54,57,59,60,63,67,69]
# TN_PDN = {1:1, 2:15, 3:16, 6:14, 7:13, 10:10, 17:33, 21:17, 22:9, 23:3, 24:2, 25:4, 26:5, 29:11, 30:8, 31:13,
#           32:9, 33:10, 35:43,36:44,42:46,43:48,44:49,45:50,46:115,48:118,52:113,53:95,54:84,57:58,59:59,60:68,63:80, 67:88, 69:87,
#           0:-1}
...
# TN_PDN = {1:6,2:9, 3:8,6:13 ,7:7  ,10:17, 12:11 ,13:12,16:19,  20: 20,
#           21:1, 22:118, 25:2, 27:3, 29:56, 32:23, 35:111, 36:107, 38:100, 45:107,0:-1}

TN_PDN = {1:24,2:23, 3:22,6:20 ,7:25  ,10:17, 12:30 ,13:26,16:32,  20: 6,
          21:11, 22:96, 25:8, 27:13, 29:66, 32:51, 35:52, 36:53, 38:59, 45:56,0:-1}


# J = [1,2,3, 6,7,10,12,13,16,20,21,22,23,29,30,35,36,37,42,43,50,52,53,54,55,57,58,61,62,67,69,72,73,74]
# TN_PDN = {1:8 ,2: 11, 3: 6, 6:7, 7:17, 10:12,12:22, 13:20, 16:5, 20:51, 21:4, 22:118,23:2, 29:1,30:3,35:104,
#           36:107,37:24,42:109,43:108,50:26,52:112,53:111,54:96,55:54,57:53,58:52,61:57,62:59,67:66,69:100,
#           72:56,73:25,74:26, 0:-1}
...
for i in range(1,number_scenario):
    ...
    for name in c2_5_name:
        index = int(name.split("_")[1:][-1])
        coef = P_load_dict[index][i]
        stoch.write('    {:<20s}{:<20s}{:>25.5f}\n'.format( 'rhs',name ,coef))
        
    for name in c2_6_name:
        index = int(name.split("_")[1:][-1])
        coef = Q_load_dict[index][i]
        stoch.write('    {:<20s}{:<20s}{:>25.5f}\n'.format( 'rhs',name ,coef))
