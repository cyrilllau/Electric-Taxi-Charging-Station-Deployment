...
Utility  = pd.read_excel('Utility_new.xlsx',index_col=[0,1])
...
L = 0.001 #Substation Capacity Expansion Cost#
...
beta = 0.2 # 1adjust Expansion line; default value = 1
...
H = 2*G
H_0 = 1.5
J = [7,10,12,13,16,20,21,22,25,27, 29,32,35,36,38,45]

TN_PDN = {7:22  ,10:17, 12:11 ,13:12,16:19,  20: 35,
          21:1, 22:118, 25:2, 27:53, 29:66, 32:18, 35:39, 36:41, 38:100, 45:34,0:-1} # fast

J = [1,3,2,6,7,10,12,13,16,20,21,22,25,27, 29,32,35,36,38,45]
TN_PDN = {1:13, 2:9, 3:8,6:13 ,7:7  ,10:17, 12:11 ,13:12,16:19,  20: 20,
          21:3, 22:118, 25:2, 27:4, 29:66, 32:56, 35:39, 36:36, 38:100, 45:51,0:-1}
...
J_start = [7, 10,12,13,16,20,21,22,25,27,32,35,36,38,45]
X_start = {7:0, 10:0, 12:0 ,13:0,16:0,  20: 0,
          21:0, 22:0, 25:0, 27:0, 32:0, 35:0, 36:0, 38:0, 45:0} 

J_start = [6,7,10,12,13,16,20,25, 29,32,35,38,45]

X_start = {6:10, 7:10, 10:56, 12:10, 13:18, 16:21, 20:10, 25:580, 29:10, 32:10,35:115,38:10,45:119}
...
stoch.write('{:^4s}{:<20s}{:<20s}{:>25.5f}  {}\n'.format('SC','SCO',"'ROOT'",39/108,'PERIOD2'))


for i in range(1,number_scenario):
    sc = 'SC'+str(i)
    if i ==1 :
        stoch.write('{:^4s}{:<20s}{:<20s}{:>25.5f}  {}\n'.format('SC', sc,"'ROOT'",69/108,'PERIOD2'))

    if 0 < number_scenario < 3:
        Umin = 0.55
    else:
        Umin = 0.55
