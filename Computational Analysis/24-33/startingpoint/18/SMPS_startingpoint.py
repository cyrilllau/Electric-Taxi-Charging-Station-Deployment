...
D_mat = pd.read_excel('demand18.xlsx').values[:,1: number_scenario + 1][0:]
Demand_Multiplier = 2
...
Utility  = pd.read_excel('utility18.xlsx',index_col=[0,1])
...
P_load_mat = pd.read_excel('pload18.xlsx').values[:,1:number_scenario+1]
Q_load_mat = pd.read_excel('qload18.xlsx').values[:,1:number_scenario+1]
...
X_start = {1:32, 5:86, 11:64, 13:60, 14:54, 15:147, 16:207}
U_start = []
