...
D_mat = pd.read_excel('Demand432.xlsx').values[:,1: number_scenario + 1][0:]
Demand_Multiplier = 2
...
P_load_mat = pd.read_excel('Pload432.xlsx').values[:,1:number_scenario+1]
Q_load_mat = pd.read_excel('Qload432.xlsx').values[:,1:number_scenario+1]
...
X_start = {1:36, 5:95, 11:84, 13:58, 14:69, 15:98, 16:100}
U_start = []
