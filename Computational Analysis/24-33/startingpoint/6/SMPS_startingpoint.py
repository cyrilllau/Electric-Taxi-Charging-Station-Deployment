...
P_load_mat = pd.read_excel('pload6.xlsx').values[:,1:number_scenario+1]
Q_load_mat = pd.read_excel('qload6.xlsx').values[:,1:number_scenario+1]
...
X_start = {1:32, 5:86, 11:64, 13:62, 14:54, 15:95, 16:21}
U_start = []
